...
* Một tập lệnh tiện ích để trích xuất các liên kết video từ hồ sơ người dùng DouYin

* 
* Cách sử dụng:

* 1. Truy cập trang hồ sơ người dùng DouYin

* 2. Mở bảng điều khiển trình duyệt và dán tập lệnh này

* 3. Chạy tập lệnh để tải xuống một tệp văn bản chứa tất cả các URL video

* 4. Nhập các URL vào trình quản lý tải xuống
